...
# installed.
TCL_PREFIX='/Applications/SM64EXLC.app/libexec/macports'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/Applications/SM64EXLC.app/libexec/macports'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/Users/alex/dev/sm64ex_leopard_compiler/macports-base/vendor/tcl/unix -ltcl8.5'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/Applications/SM64EXLC.app/libexec/macports/lib -ltcl8.5'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/Applications/SM64EXLC.app/libexec/macports/include'
...
# compiled.
TCL_SRC_DIR='/Users/alex/dev/sm64ex_leopard_compiler/macports-base/vendor/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/Applications/SM64EXLC.app/libexec/macports/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/Users/alex/dev/sm64ex_leopard_compiler/macports-base/vendor/tcl/unix -ltclstub8.5'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/Applications/SM64EXLC.app/libexec/macports/lib -ltclstub8.5'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/Users/alex/dev/sm64ex_leopard_compiler/macports-base/vendor/tcl/unix/libtclstub8.5.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/Applications/SM64EXLC.app/libexec/macports/lib/libtclstub8.5.a'
